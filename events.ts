...
export const EVENTS: MarketEvent[] = [
  { id: "black-monday-1987", date: "10-19", year: 1987, index: "Dow Jones", movePercent: -22.6, type: "crash", arcana: "tower",
  ...
  { id: "black-thursday-1929", date: "10-24", year: 1929, index: "Dow Jones", movePercent: -2.1, type: "crash", arcana: "hanged-man",
  ...
  { id: "black-tuesday-1929", date: "10-29", year: 1929, index: "Dow Jones", movePercent: -11.7, type: "crash", arcana: "tower",
  ...
  { id: "black-monday-1929", date: "10-28", year: 1929, index: "Dow Jones", movePercent: -13.5, type: "crash", arcana: "tower",
  ...
  { id: "tarp-rejected", date: "09-29", year: 2008, index: "Dow Jones", movePercent: -7.0, type: "crash", arcana: "tower",
  ...
  { id: "lehman", date: "09-15", year: 2008, index: "Dow Jones", movePercent: -4.4, type: "crash", arcana: "tower",
  ...
  { id: "covid-black-monday", date: "03-09", year: 2020, index: "Dow Jones", movePercent: -7.8, type: "crash", arcana: "tower",
  ...
  { id: "covid-black-thursday", date: "03-12", year: 2020, index: "Dow Jones", movePercent: -10.0, type: "crash", arcana: "tower",
  ...
  { id: "covid-worst", date: "03-16", year: 2020, index: "S&P 500", movePercent: -12.0, type: "crash", arcana: "tower",
  ...
  { id: "covid-bottom", date: "03-23", year: 2020, index: "S&P 500", movePercent: 0.5, type: "turn", arcana: "death",
  ...
  { id: "flash-crash", date: "05-06", year: 2010, index: "Dow Jones", movePercent: -3.2, type: "quirk", arcana: "wheel",
  ...
  { id: "gme-squeeze", date: "01-27", year: 2021, index: "GameStop (GME)", movePercent: 135.0, type: "quirk", arcana: "devil",
  ...
  { id: "gme-halt", date: "01-28", year: 2021, index: "GameStop (GME)", movePercent: -44.0, type: "quirk", arcana: "hanged-man",
  ...
  { id: "dotcom-peak", date: "03-10", year: 2000, index: "Nasdaq", movePercent: 0.0, type: "turn", arcana: "devil",
  ...
  { id: "dotcom-bottom", date: "10-09", year: 2002, index: "Nasdaq", movePercent: 0.5, type: "turn", arcana: "death",
  ...
  { id: "brexit", date: "06-24", year: 2016, index: "FTSE 100", movePercent: -3.15, type: "crash", arcana: "tower",
  ...
  { id: "china-2015", date: "08-24", year: 2015, index: "Dow Jones", movePercent: -3.6, type: "crash", arcana: "tower",
  ...
  { id: "volmageddon", date: "02-05", year: 2018, index: "Dow Jones", movePercent: -4.6, type: "crash", arcana: "tower",
  ...
  { id: "g7-rally", date: "10-13", year: 2008, index: "Dow Jones", movePercent: 11.1, type: "boom", arcana: "chariot",
  ...
  { id: "crisis-rally-2", date: "10-28", year: 2008, index: "Dow Jones", movePercent: 10.9, type: "boom", arcana: "chariot",
  ...
  { id: "fed-cuts-zero", date: "12-16", year: 2008, index: "Dow Jones", movePercent: 4.2, type: "boom", arcana: "star",
  ...
  { id: "xmas-eve-massacre", date: "12-24", year: 2018, index: "Dow Jones", movePercent: -2.9, type: "crash", arcana: "tower",
  ...
  { id: "boxing-day-rally", date: "12-26", year: 2018, index: "Dow Jones", movePercent: 5.0, type: "boom", arcana: "sun",
  ...
  { id: "9-11-reopen", date: "09-17", year: 2001, index: "Dow Jones", movePercent: -7.1, type: "crash", arcana: "tower",
  ...
  { id: "downgrade-monday", date: "08-08", year: 2011, index: "Dow Jones", movePercent: -5.6, type: "crash", arcana: "tower",
  ...
  { id: "downgrade-rebound", date: "08-09", year: 2011, index: "Dow Jones", movePercent: 4.0, type: "boom", arcana: "star",
  ...
  { id: "asian-crisis-1997", date: "10-27", year: 1997, index: "Dow Jones", movePercent: -7.2, type: "crash", arcana: "hanged-man",
  ...
  { id: "carry-trade-unwind", date: "08-05", year: 2024, index: "Nikkei 225", movePercent: -12.4, type: "crash", arcana: "tower",
  ...
  { id: "nasdaq-2022-peak", date: "01-03", year: 2022, index: "Nasdaq", movePercent: 0.0, type: "turn", arcana: "devil",
  ...
  { id: "bear-market-confirmed", date: "06-13", year: 2022, index: "S&P 500", movePercent: -3.9, type: "crash", arcana: "justice",
  ...
  { id: "cpi-whiplash", date: "10-13", year: 2022, index: "S&P 500", movePercent: 2.6, type: "quirk", arcana: "wheel",
  ...
  { id: "kennedy-slide", date: "05-28", year: 1962, index: "Dow Jones", movePercent: -5.7, type: "crash", arcana: "tower",
  ...
  { id: "gulf-war-rally", date: "01-17", year: 1991, index: "Dow Jones", movePercent: 4.6, type: "boom", arcana: "star",
  ...
  { id: "jfk-market-closes", date: "11-22", year: 1963, index: "Dow Jones", movePercent: -2.9, type: "crash", arcana: "hanged-man",
  ...
  { id: "jfk-rebound", date: "11-26", year: 1963, index: "Dow Jones", movePercent: 4.5, type: "boom", arcana: "sun",
  ...
  { id: "dotcom-single-worst", date: "04-14", year: 2000, index: "Nasdaq", movePercent: -9.7, type: "crash", arcana: "tower",
  ...
  { id: "negative-oil", date: "04-20", year: 2020, index: "WTI Crude Oil", movePercent: -305.97, type: "quirk", arcana: "fool",
  ...
  { id: "crowdstrike-outage", date: "07-19", year: 2024, index: "Global Markets", movePercent: -0.7, type: "quirk", arcana: "fool",
  ...
  { id: "mag7-selloff", date: "07-24", year: 2024, index: "Nasdaq", movePercent: -3.6, type: "crash", arcana: "tower",
  ...
  { id: "china-mini-crash-2007", date: "02-27", year: 2007, index: "Dow Jones", movePercent: -3.3, type: "crash", arcana: "tower",
...
// Cumulative days before each month in a non-leap year, used only to rank
// calendar closeness (not real dates), so Feb 29 is a non-issue here.
...
export function findClosestEvent(month: number, day: number, year?: number): { event: MarketEvent; exact: boolean; daysAway: number } {
  ...
  for (const e of EVENTS) {
    const [m, d] = e.date.split("-").map(Number);
    const pos = dayOfYear(m, d);
    let dist = Math.abs(pos - target);
    dist = Math.min(dist, DAYS_IN_YEAR - dist); // wrap around the year
    if (dist < bestDist) {
      bestDist = dist;
      best = e;
    }
  ...
  return { event: best as MarketEvent, exact: false, daysAway: bestDist };
}
